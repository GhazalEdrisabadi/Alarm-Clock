...
_0x0:
	.DB  0x20,0x20,0x41,0x6C,0x61,0x72,0x6D,0x20
	.DB  0x20,0x43,0x6C,0x6F,0x63,0x6B,0x20,0x20
	.DB  0x0,0x4F,0x4E,0x20,0x0,0x4F,0x46,0x46
	.DB  0x0,0x54,0x69,0x6D,0x65,0x3A,0x20,0x25
	.DB  0x32,0x64,0x3A,0x25,0x30,0x32,0x64,0x3A
	.DB  0x25,0x30,0x32,0x64,0x0,0x41,0x6C,0x72
	.DB  0x6D,0x3A,0x20,0x25,0x32,0x64,0x3A,0x25
	.DB  0x30,0x32,0x64,0x20,0x25,0x73,0x0
_0x2020003:
	.DB  0x80,0xC0
...
; 0000 00B3                 alarmstate = 255;
	LDI  R26,LOW(_alarmstate)
	LDI  R27,HIGH(_alarmstate)
	LDI  R30,LOW(255)
	CALL __EEPROMWRB
...
; 0000 00D4     sprintf(lcd_buff,"Alrm: %2d:%02d %s", alhour, alminute, alarm_state);
	...
	CALL SUBOPT_0x8
	CALL SUBOPT_0x9
	LDI  R30,LOW(_alarm_state)
	LDI  R31,HIGH(_alarm_state)
	CLR  R22
	CLR  R23
	CALL __PUTPARD1
	LDI  R24,12
